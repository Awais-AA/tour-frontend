...
function Navbar() {
  ...
  return (
    ...
    <div className="container"><Link className="navbar-brand d-flex align-items-center" to="/"><span className="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon">
      <svg className="bi bi-bezier" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                ...
                </svg></span><span>TourOn</span></Link><button className="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navcol-1"><span className="visually-hidden">Toggle navigation</span><span className="navbar-toggler-icon"></span></button>
        <div id="navcol-1" className="collapse navbar-collapse">
          ...
          <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><Link className="dropdown-item" to="/user-polling">UserPoll</Link></li>
            <li><Link className="dropdown-item" to="/user-polling">TravelAgent Poll</Link></li>
            <li><Link className="dropdown-item" to="/user-polling">Group Poll</Link></li>
          </ul>
        </li>
            ...
            <>
              ...
              <ul className="navbar-nav">
                <li className="nav-item" ><p className="nav-link active">{user.username}</p></li>
              <li className="nav-item" onClick={onClick}><p className="nav-link text-danger">Logout</p></li>
              </ul>
            </>
            :<>
