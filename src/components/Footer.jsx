function Footer() {
  return (<div>
    ...
    <div className="container">
        <div className="border rounded border-white d-flex flex-column justify-content-between align-items-center flex-lg-row text-bg-light bg-primary-gradient p-4 p-lg-5">
            <div className="text-center text-lg-start py-1 py-lg-1">
                <h2 className="fw-bold mb-">Subscribe to our newsletter</h2>
    ...
    <div className="container py-4 py-lg-5">
        <div className="row justify-content-center">
            ...
            <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                <div className="fw-bold d-flex align-items-center mb-2"><span className="bs-icon-sm bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2"><svg className="bi bi-bezier" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        </svg></span><span>TourOn</span></div>
                <p className="text-muted">TourOn Facillitates people to book tour for famous places.</p>
            </div>
        </div>
        <hr />
        <div className="text-muted d-flex justify-content-between align-items-center pt-3">
            <p className="mb-0">Copyright © 2023 TourOn</p>
